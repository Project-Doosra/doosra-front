...
export async function GET(
  ...
  const playerData = {
    1: {
      ...
      headerImage:
        "https://akm-img-a-in.tosshub.com/indiatoday/images/story/202402/pat-cummins-190017942-3x4.jpeg?VersionId=zbO.bV8Ms3m9ZLlQr5duknjihXhMPEQ6",
      careerStats: {
        matches: 88,
        wickets: 141,
        runsScored: 492,
      ...
      videos: [
        {
          id: 1,
          title: "Cummins press conference 1",
          thumbnail: "/video1-thumb.jpg",
        },
        {
          id: 2,
          title: "Cummins press conference 2",
